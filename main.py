                ...
                while True:
                    try:
                        ...
                        if int(product_quantity) <= 0:
                            ...
                            break
                        if int(product_quantity) > best_buy.get_all_products()[product_option].quantity:
                            print("------")
                            print(f"Only {best_buy.get_all_products()[product_option].quantity} in the stock!\n"
                                  f"Please enter the exact amount or lower that we have!")
                            break
